            ...
            <div class="search-box">
                <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                    <input class="form-control search-input search" type="search"
                        placeholder="Mijozlarni shu yerdan izlang!" aria-label="Search" />
                    ...
                    @foreach ($partners as $partnerDetail)
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="created_by align-middle white-space-nowrap">
                                <span
                                    class="badge {{ $partnerDetail->status === 'active' ? 'bg-success' : 'bg-warning' }}">
                                    {{ ucfirst($partnerDetail->status) }}
                                </span>
                            </td>
