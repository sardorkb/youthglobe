...
@section('title','Yangilikni tahrirlash | Baraka Development')
      ...
      <form method="post" action="{{route('post.update',$post->id)}}">
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            <option value="active" {{(($post->status=='active')? 'selected' : '')}}>Aktiv</option>
            <option value="inactive" {{(($post->status=='inactive')? 'selected' : '')}}>Aktiv emas</option>
        </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
